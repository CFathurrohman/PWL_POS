...
class PenjualanController extends Controller
{
    ...
    {
        $penjualan = PenjualanModel::select('penjualan_id', 'user_id', 'pembeli', 'penjualan_kode', 'penjualan_time')->with('user');
        ...
        return DataTables::of($penjualan)
            ...
            ->addColumn('aksi', function ($penjualan) { // menambahkan kolom aksi
                ...
                $btn .= '<a href="' . url('/penjualan/' . $penjualan->penjualan_id . '/edit') . '" class="btn btn-warning btn-sm mr-2">Edit</a> ';
    ...
    public function store(Request $request)
    {
        ...
        $transaksiPenjualan = PenjualanModel::create([
            ...
            'penjualan_time' => $request->penjualan_time
        ]);
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'penjualan_time' => 'required|date_format:Y-m-d\TH:i',
            'barang_id' => 'required|integer',
        ...
        $penjualan->penjualan_time = $request->penjualan_time;
        $penjualan->save();
